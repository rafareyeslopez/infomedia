...
@XmlType(name = "", propOrder = { "username", "md5Hash", "smsMessage", "msisdnList", "userMsgID", "userTag",
		"scheduleFor", "campaignID" })
@XmlRootElement(name = "SendMessageWithCampaign")
public class SendMessageWithCampaign {
	 ...
	 *
	 * @return possible object is {@link ArrayOfMSISDNDetails }
	 *
	 */
	 ...
	 *
	 * @param value allowed object is {@link ArrayOfMSISDNDetails }
	 *
	 */
